    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
                ...
                <div class="row mb-2">
                    <div class="col-6">
                       <select style="height: 26px;" onchange="return window.location.href = '?lr='+this.value"> 
                      <option value="">Select Company Types</option>
                      @foreach($companies as $company)
                         <option value="{{ $company->id }}" {{ (@request()->lr == $company->id) ? 'selected' : ''}}> {{ $company->name }}</option>
                      @endforeach
                      </select>
                    </div>
                </div>
